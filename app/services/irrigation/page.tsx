...
export default function IrrigationPage() {
  ...
  const createWhatsappLink = (packageName: string) => {
    const message = `Hi GreenThumb KE, I'm interested in the ${packageName} irrigation package.`
      ...
      <section className="bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16">
          <div className="relative aspect-[16/9] w-full rounded-3xl overflow-hidden shadow-2xl border border-white/40">
            <Image
              src="/pictures/Irrigation Systems.png"
              alt="Irrigation systems installed by GreenThumb KE"
              fill
